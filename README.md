...
This part is described in more detail in the 📂 [Firmware Implementation](Firmware_Implementation/) section of the repository, where the following aspects are covered:
